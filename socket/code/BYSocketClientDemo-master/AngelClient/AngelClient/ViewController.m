...
// 信息展示
@property (weak, nonatomic) IBOutlet UITextView *showMessageTextF;
...
//    NSLog(@"连接主机对应端口%@", sock);
    ...
    NSString *firstMes = [NSString stringWithFormat:@"我是iOS 端 %f",version];
...
{
    self.showMessageTextF.text = [self.showMessageTextF.text stringByAppendingFormat:@"%@\n", str];
}
